/*
Ejercicio 3: Leer 5 numeros por teclado, almacenarlos en un arreglo y a constinuacion realizar la media de los
...
public class Arreglos_Ejercicio_3 {
    public static void main(String[] args) {
        ...
        System.out.println("Guardamos los elmentos del arreglo");
        for(int i = 0; i < 5; i++) {
        ...
        if (conteo_negativos == 0) {
            ...
            System.out.println("La me dia de los numeros negativos es: "+mediaNegativos);
        }
