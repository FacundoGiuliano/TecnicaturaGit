...
con el modificador de acceso estatico para convertir una variable
en una constante, es decir que no se puede modificar su valor.
El ejemplo de esto es la clase math en la cual todos sus atributos son de tipo
...
public class TestFinal {
    public static void main(String[] args) {
        final int miDni = 3931522;
        System.out.println("miDni = " + miDni);
        //miDni = 2132123; No se puede modificar
        ...
        persona1.setNombre("Facundo Giuliano");
        System.out.println("persona1 nombre: "+persona1.getNombre());
    }
}
